...
def run_test_make_simple_string():
    ...
    actual = make_simple_string(21, 26)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    expected = '21-22-23-24-25-26'
    actual = make_less_simple_string(21, 26)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ref = circles[k].center
        point1 = rg.Point(ref.x + circles[k].radius, ref.y + circles[k].radius)
        point2 = rg.Point(ref.x - circles[k].radius, ref.y - circles[k].radius)
        rectangles = rectangles + rg.Rectangle(point1, point2)
    return rectangles
